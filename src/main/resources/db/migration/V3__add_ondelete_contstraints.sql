...
alter table email_confirmation
    drop constraint if exists fk_email_confirmation_account_id,
...
alter table project_info
    drop constraint if exists fk_project_info_author_account_id,
...
alter table project_tag
    drop constraint if exists fk_project_tag_project,
    add constraint fk_project_tag_project
        foreign key (project_id) references project_info
            on delete cascade;

alter table project_tag
    drop constraint if exists fk_project_tag_tag,
...
alter table project_user_favourite
    drop constraint if exists fk_project_user_favourite_project,
    add constraint fk_project_user_favourite_project
        foreign key (project_id) references project_info
            on delete cascade;

alter table project_user_favourite
    drop constraint if exists fk_project_user_favourite_user,
...
alter table project_user_pull
    drop constraint if exists fk_project_user_pull_project,
    add constraint fk_project_user_pull_project
        foreign key (project_id) references project_info
            on delete cascade;

alter table project_user_pull
    drop constraint if exists fk_project_user_pull_user,
...
alter table project_user_watch
    drop constraint if exists fk_project_user_watch_project,
    add constraint fk_project_user_watch_project
        foreign key (project_id) references project_info
            on delete cascade;

alter table project_user_watch
    drop constraint if exists fk_project_user_watch_user,
...
alter table project_version
    drop constraint if exists fk_project_info_versions,
...
alter table project_env_param
    drop constraint if exists fk_project_env_param_project_version,
...
alter table project_info
    drop constraint if exists fk_project_info_default_project_version,
